...
class URDFViewer extends HTMLElement {
    ...
    constructor() {
        ...
        const secondaryDirLight = new THREE.DirectionalLight(0xffffff, 0.7 * Math.PI);
        ...
        // 额外的环境光，用于提供均匀的基本照明
        const ambientFillLight = new THREE.AmbientLight(0xffffff, 0.3);
        ...
        switch (attr) {
            ...
            case 'ambient-color': {
                ...
                if (this.ambientFillLight) {
                    // 创建颜色对象进行处理
                    const fillColor = new THREE.Color(this.ambientColor);
                    // 保持原有色调，但亮度提高，饱和度降低
