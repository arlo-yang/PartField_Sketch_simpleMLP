...
class PtsInfo {
 public:
  enum PropType { kPoint = 1, kNormal = 2, kFeature = 4, kLabel = 8, kFaceIndex = 16 };
  static const int kPTypeNum = 5;
...
class Points {
 public:
  ...
  int* mutable_ptr_int(PtsInfo::PropType ptype);
  void copy_int_data(vector<int>::const_iterator begin, vector<int>::const_iterator end, int* dest);
