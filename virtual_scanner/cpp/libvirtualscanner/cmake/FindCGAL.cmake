...
message(STATUS "GMP_LIBRARIES=${GMP_LIBRARIES}")
  ...
  if(CGAL_INCLUDE_DIR AND NOT CGAL_LIBRARIES)
    # For conda environment, we might need to use a different approach
    set(CGAL_LIBRARIES "$ENV{CONDA_PREFIX}/lib/libCGAL.so")
    if(EXISTS "${CGAL_LIBRARIES}")
      message(STATUS "Using conda CGAL library: ${CGAL_LIBRARIES}")
    endif()
  endif()
